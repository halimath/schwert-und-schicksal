...
kannst eine Kutsche anheben, so dass ein anderer Charakter das defekte Wagenrad einfacher reparieren kann.
...
[.icon]#O# Du kannst an einem Türsteher vorbeikommen, in dem du ihn provozierst, so dass er seinen Posten 
aufgibt.
