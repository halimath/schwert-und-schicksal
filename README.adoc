...
Du solltes vertraut mit Fate Core sein, um diese Regeln sinnvoll einsetzen zu können. Erfahrungen mit anderen
...
Wenn Du _Schwert & Schicksla_ einfach nur spielen möchtest, schau am besten in die
